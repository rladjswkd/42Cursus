...
namespace ft {
	...
	inline set<Key, Compare, Allocator>::set() /* tree() */{ }

	template <typename Key, typename Compare, typename Allocator>
	inline set<Key, Compare, Allocator>::set(const Compare &comp, const Allocator &alloc) /* tree(comp, alloc) */ {
	}

	template <typename Key, typename Compare, typename Allocator>
	template <typename InputIt>
	inline set<Key, Compare, Allocator>::set(InputIt first, InputIt last, const Compare &comp, const Allocator &alloc) /* tree(comp, alloc)*/ {
		/* tree.insert(first, last);*/
	}

	template <typename Key, typename Compare, typename Allocator>
	inline set<Key, Compare, Allocator>::set(const set &other) /* tree(other.tree) */ {	}

	template <typename Key, typename Compare, typename Allocator>
	inline set<Key, Compare, Allocator>::~set() { }

	template <typename Key, typename Compare, typename Allocator>
	inline set<Key, Compare, Allocator>	&set<Key, Compare, Allocator>::operator=(const set &other) const {
		/* tree = other.tree */
		return (*this);
	}
	...
	template <typename Key, typename Compare, typename Allocator>
	inline set<Key, Compare, Allocator>::size_type	set<Key, Compare, Allocator>::erase(const key_type& k) {
		return (/*tree.erase(k)*/);
	}
